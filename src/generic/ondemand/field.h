...
protected:
  simdjson_really_inline field(raw_json_string key, json_iterator_ref &&value) noexcept;
  static simdjson_really_inline simdjson_result<field> start(json_iterator_ref &&parent_iter) noexcept;
