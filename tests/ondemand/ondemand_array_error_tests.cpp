...
namespace array_error_tests {
  ...
  bool top_level_array_iterate_error() {
    ...
    ONDEMAND_SUBTEST("extra comma  ", "[1,,1]", assert_iterate(doc, { int64_t(1) }, { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("extra comma  ", "[,]",    assert_iterate(doc,                 { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("extra comma  ", "[,,]",   assert_iterate(doc,                 { TAPE_ERROR, TAPE_ERROR }));
    TEST_SUCCEED();
  }
  ...
  bool array_iterate_error() {
    ...
    ONDEMAND_SUBTEST("extra comma  ", R"({ "a": [1,,1] })", assert_iterate(doc["a"], { int64_t(1) }, { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("extra comma  ", R"({ "a": [1,,] })",  assert_iterate(doc["a"], { int64_t(1) }, { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("extra comma  ", R"({ "a": [,] })",    assert_iterate(doc["a"],                 { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("extra comma  ", R"({ "a": [,,] })",   assert_iterate(doc["a"],                 { TAPE_ERROR, TAPE_ERROR }));
    TEST_SUCCEED();
  }
  ...
  bool array_iterate_incomplete_error() {
    ...
    ONDEMAND_SUBTEST("unclosed after array", R"([ [1,])", assert_iterate(doc.get_array().at(0), { int64_t(1) }, { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("unclosed after array", R"([ [1])",  assert_iterate(doc.get_array().at(0), { int64_t(1) }, { INCOMPLETE_ARRAY_OR_OBJECT }));
    ...
    ONDEMAND_SUBTEST("unclosed after array", R"({ "a": [1,])",        assert_iterate(doc["a"], { int64_t(1) }, { TAPE_ERROR, TAPE_ERROR }));
    ONDEMAND_SUBTEST("unclosed after array", R"({ "a": [1])",         assert_iterate(doc["a"], { int64_t(1) }                                ));
