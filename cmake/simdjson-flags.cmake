...
#
option(SIMDJSON_PRODUCTION "Optimize for production by removing development-time aids, such as incorrect API usage checks." ON)
if(SIMDJSON_PRODUCTION)
  message(STATUS "SIMDJSON_PRODUCTION is ON: optimizing for production by removing development-time aids, such as incorrect API usage checks.")
else()
  message(STATUS "Development-time aids enabled. Use cmake -DSIMDJSON_PRODUCTION=ON to disable develop-time aids, such as incorrect API usage checks.")
