...
really_inline uint32_t& parser::n_structural_indexes() const noexcept {
  return implementation->n_structural_indexes;
}
really_inline std::unique_ptr<uint32_t[]>& parser::structural_indexes() const noexcept {
  return implementation->structural_indexes;
}
