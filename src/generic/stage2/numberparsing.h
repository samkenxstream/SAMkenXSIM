...
#define WRITE_INTEGER(VALUE, SRC, VISITOR) (found_integer((VALUE), (SRC)), (VISITOR).visit_integer((VALUE)))
#define WRITE_UNSIGNED(VALUE, SRC, VISITOR) (found_unsigned_integer((VALUE), (SRC)), (VISITOR).visit_unsigned_integer((VALUE)))
...
#define WRITE_INTEGER(VALUE, SRC, VISITOR) (VISITOR).visit_integer((VALUE))
#define WRITE_UNSIGNED(VALUE, SRC, VISITOR) (VISITOR).visit_unsigned_integer((VALUE))
